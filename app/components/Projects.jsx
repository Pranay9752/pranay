...
const ProjectsSection = () => {
  ...
  const projects = [
    {
      id: 1,
      name: "Retailer-one Platform",
      description: "A comprehensive platform built for retailers to manage inventory, sales, and customer data with real-time analytics.",
      image: "/api/placeholder/600/400",
      tags: ["React.js", "Redux", "Tailwind CSS", "RTK Query"],
      githubUrl: "https://github.com/username/retailer-one",
      demoUrl: "https://retailer-one.demo.com",
      status: "completed"
    },
    {
      id: 2,
      name: "E-Commerce Dashboard",
      description: "An interactive dashboard for e-commerce businesses with sales analytics, inventory tracking, and order management.",
      image: "/api/placeholder/600/400",
      tags: ["Next.js", "Context API", "Tailwind CSS"],
      githubUrl: "https://github.com/username/ecommerce-dashboard",
      demoUrl: "https://ecommerce-dash.demo.com",
      status: "working"
    },
    {
      id: 3,
            ...
            >
              <div className="relative">
                <div className="absolute top-4 right-4 z-10">
                  <span className={`text-xs font-medium px-3 py-1 rounded-full capitalize ${getStatusBadgeStyle(project.status)}`}>
                    {project.status}
                  </span>
                </div>
              ...
              <div className="p-6 relative z-10">
                ...
                <div className="mt-6 pt-4 border-t border-gray-700/50 flex justify-between items-center">
                  ...
                  <a
                    ...
                    className="flex items-center text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 shadow-lg shadow-blue-500/20"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
